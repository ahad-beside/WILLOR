...
<div id="admin-mainbody">
  ...
  <tbody>
    <tr>
      ...
      <td width="94%" class="welcome">Transfer Transactions<br>
    ...
    <tr>
      <td height="46" colspan="2" align="left" valign="top" class="passacc"><table width="100%" border="0" cellspacing="5" cellpadding="5">
        <tbody>
          <tr>
            <td width="23%" bgcolor="#F0F0F0">
            <span class="warning">Transfer ID:</span> <span class="passacc"><?php echo $row['id']; ?> - <?php echo ucwords($row['type']); ?></span> <span class="passacc">Transfer <br>
    ...
    <tr>
      <td height="49" colspan="2" align="center" class="warning"><table width="100%" border="0" cellspacing="5" cellpadding="5">
        <tbody>
          <tr class="formtext">
            <td width="15%" bgcolor="#F0F0F0"><p><span class="passacc"><strong>Date Initiated:</strong></span> <?php echo $row['date']; ?></p></td>
            <td width="29%" bgcolor="#F0F0F0"><p><strong><span class="register">Completion Date:</span></strong> <?php echo $dateoftransfer; ?></p></td>
            <td width="56%" bgcolor="#F0F0F0" class="Rbutton">
            
             <?php if($completed<100){ ?> <center><strong>TRANSFER IS IN PROGRESS</strong></center><?php }else{ ?>
            <center><strong>TRANSFER COMPLETED</strong></center> <?php } ?>
          ...
          <tbody>
            <tr>
              ...
              <td width="56%"><label for="textfield9" class="formtext">Receiver Bank*:</label>
                <input readonly class="input-admin" type="text" value="<?php echo $row['receiverbank']; ?>"></td>
              </tr>
            <tr>
            ...
            <tr>
              ...
              <td><label for="textfield15" class="formtext">Transfer Completion Date:</label>
                <input  readonly  class="input-admin" type="" value="<?php echo $dateoftransfer; ?>"></td>
              </tr>
            <tr>
              <td><span class="Rbutton"><a class="btn btn-primary" href="transfers.php">Go Back</a>
                  <?php if(empty($dateoftransfer)){ ?>
