...
<html>
  <head>
    <title>Update - Transfer ID: <?php echo $row['id']; ?></title>
        ...
        <form id="formValidate" method="post">
          ...
          <fieldset class="form-group">
            ...
            <div class="form-buttons-w">
                <div class="form-group">
                  <label for="">Expected Date of Transfer Completion</label>
                  <input required class="single-daterange form-control" type="text" value="<?php if(!empty($dateoftransfer)) {echo date('m/d/Y', strtotime($dateoftransfer));} ?>" name="dateoftransfer">
              </div>
            <button class="btn btn-primary" type="submit" name="submit"> Submit</button>
            <a class="btn btn-success" href="transfers.php"> Go Back</a>
          </div>
