...
else if($type == "SA") {$atype = "Savings Account";}
else if($type == "TA") {$atype = "Transit Account";}
else if($type == "COA") {$atype = "Confidential Account";}
?>
...
<form action="process.php?action=transaction" method="post" id="frmTransaction">
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
  <tr> 
   ...
   ?>
   	<img src="<?php echo WEB_ROOT; ?>images/<?php echo $upics; ?>" style="float:right;" width="180" height="180" />   </td>
  </tr>
  ...
  <tr> 
   ...
   <td class="content"><strong><?php echo $acc_no; ?></strong>&nbsp;&nbsp;(<?php echo $atype; ?>)
	...
	<input type="hidden" name="acc_no" value="<?php echo $acc_no; ?>" />   </td>
   </tr>
  
  <tr> 
   <td width="150" class="label">Current Balance</td>
   <td colspan="2" class="content">&euro;&nbsp;<?php echo number_format($balance, 2); ?></td>
  </tr>
  
  <tr> 
   <td width="150" class="label">Transaction History</td>
   <td colspan="2" class="content">
   	<a href="<?php echo WEB_ROOT; ?>admin/account/?view=statement&accNo=<?php echo $acc_no; ?>">View Transaction History</a>	</td>
  </tr>
  
  <tr> 
   <td width="150" class="label">Credit Card</td>
   <td colspan="2" class="content">
   	<?php 
	$check = isCcAvailable($id);
	if(!is_bool($check)) {
	?>
   	<a href="<?php echo WEB_ROOT; ?>admin/cards/?view=view&ccId=<?php echo $check; ?>">View Credit Card Details</a>
	<?php } else { ?>
	<span style="background-color:#FFFF99;color:#CC0000;">No active credit card available.</span>&nbsp;
	<a href="<?php echo WEB_ROOT; ?>admin/cards/?view=add&id=<?php echo $id; ?>">Want to add new Credit Card ?</a>
	<?php } ?>
   </td>
  </tr>
  ...
  <tr> 
   ...
   <td colspan="2" class="content">&euro; <input type="text" name="amt" id="amt" size="10" /> </td>
  </tr>
