...
?>
  <tr class="<?php echo $class; ?>"> 
   ...
   <td width="50" align="center"><?php echo "&euro;&nbsp;".$charges; ?></td>
   <td width="50" align="center"><?php echo $tx_type == "debit" ? "&euro;&nbsp;" . number_format($amount, 2) : ""; ?></td>
   <td width="50" align="center"><?php echo $tx_type == "credit" ? "&euro;&nbsp;" . number_format($amount, 2) : ""; ?></td>
