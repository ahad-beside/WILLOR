...
function transaction()
{
	...
	if (dbNumRows($result) == 1) {
		...
		$desc = sprintf("Fund transfer of &euro;%u , Account %u Reference# %s", $amt, $acc_no, $tx_no);
		$sql = "INSERT INTO tbl_transaction (user_id, tx_no, tx_type, amount, charges, date, description, to_accno, status, tdate, comments) 
				VALUES (id, '$tx_no', '$type', $amt, 0, NOW(), '$desc', '$acc_no', 'SUCCESS', '$dot', '$cmt')";
		dbQuery($sql);
		//email details...
		header('Location: index.php');
		exit();
